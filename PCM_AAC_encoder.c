...
//
//
///* Check whether the encoder supports the sampling grid */
...
//    return 0;
//}
////check whether the encoder supports the sampling rate
...
//    return 0;
//}
///* check whether the encoder support the channel layout */
...
//    // == 0 Dont setting up the force encoder
//    if (force_codec == 0) {
...
//    //ffmpeg aac encoder dont support  AV_SAMPLE_FMT_S16  dont support the audio format about packer
...
//        exit(1);
//    }
//    if (!check_sample_rate(codec, avCodecContext->sample_rate)) {
//        fprintf(stderr, "Encoder does not support sample rate %d", avCodecContext->sample_rate);
//        exit(1);
//    }
//    if (!check_channel_layout(codec, avCodecContext->channel_layout)) {
//        fprintf(stderr, "Encoder does not support channel layout %lu", avCodecContext->channel_layout);
//        exit(1);
//    }
//
//
//    printf("\n\nAudio encode config\n");
//    printf("bit_rate:%ldkbps\n", avCodecContext->bit_rate/1024);
//    printf("sample_rate:%d\n", avCodecContext->sample_rate);
//    printf("sample_fmt:%s\n", av_get_sample_fmt_name(avCodecContext->sample_fmt));
//    printf("channels:%d\n", avCodecContext->channels);
//    // frame_size是在avcodec_open2后进行关联
//    printf("1 frame_size:%d\n", avCodecContext->frame_size);
//    avCodecContext->flags = AV_CODEC_FLAG_GLOBAL_HEADER;  //ffmpeg默认的aac是不带adts，而fdk_aac默认带adts，这里我们强制不带
//    /* 将编码器上下文和编码器进行关联 */
...
//        exit(1);
//    }
//    // how much data is sent to the encoder each time is determined by:
...
//        ret = encode(avCodecContext, frame, pkt, outfile);
//        if (ret < 0) {
...
//
///* scour endcoder */
//        encode(avCodecContext, NULL, pkt, outfile);
//
//        // close file
//        fclose(infile);
//        fclose(outfile);
